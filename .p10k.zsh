# Generated by Powerlevel10k configuration wizard on 2024-03-22 at 19:28 PDT.
...
() {
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=12
  # Custom icon.
  ...
  function prompt_example() {
    # p10k segment -f 208 -i '💀' -t 'IRA, %n'
    # p10k segment -f 204 -i 'IRA' -t '💀'
    p10k segment -f 204 -i '💀' -t 'IRA'
  }
